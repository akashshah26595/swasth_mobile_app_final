...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    private static void generateNotification(Context context, String message) {
        ...
        builder.setContentTitle("Swasth Notification");
        builder.setContentText(message);
        //builder.setSmallIcon(R.drawable.swasth_logo);
        builder.setContentIntent(intent);
        builder.setOngoing(true);
        // builder.setSubText("Please fill feedback form!");   //API level 16
//        builder.setNumber(100);
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        Log.d("NAME", "err");
        aController.register(context, Dashboard.CARD_NO, registrationId);
    }
